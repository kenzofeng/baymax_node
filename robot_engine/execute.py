...
def run_script(request, project, test_id):
    ...
    try:
        ...
        if os.path.exists(argfile):
            command = "cd {}&&python -m robot.run --argumentfile {} --outputdir {}  {} ".format(script_path,argfile, reportpath,
                                                                                         script_path)
            ...
            command = "cd {}&&python -m robot.run --outputdir {} {}".format(script_path,reportpath, script_path)
